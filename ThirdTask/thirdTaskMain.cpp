...
void testHashT(){ //this thing is now just a copy of main< in the future it'll be a test for hash table
	srand(time(NULL));
	int simpleNums[5] = {13, 53, 601, 12289, 1046527}; //simple numbers for hash table size the last one is 1 046 527 for 1 million test
	int hashSize = simpleNums[0];
	// hash table: (id, index)
	vector<vector<int>> hashTable(hashSize, {-1, -1});
	int a[13];
